    ...
    <body>
        <div id="bodyWrapper">
            <div class="mainDivs" id="nav">
                    ...
                    <ul id="pagesNav">
                      <li><a class="navBtn active" href="samplingRequests.php">Sampling Orders</a></li>
            ...
            <div class="mainDivs" id="individualInfo">
                ...
                <div id="recordInfo">
                <!--COMPLETEING PLANTING REQUEST-->
                    <div id="updateRec" title="Dialog Title" class="infoSection popUpBox ">
                            <form class="popup-content animate">
                            <div class="infoSection">Collecting Request Sample</div>
                                <div id="sampId" style="display:hidden"></div>
                                    <label for="actSampleAmnt">Actual Sample Amount:</label>
                                    <input id="actSampleAmnt" name="actSampleAmnt"/> <br>
                                    <label for="date">Date:</label>
                                    <input id="date" type="date" name="date"/> <br>
                                <input type="submit" onclick='addingSample()' value="Submit" name="updateForm">
            ...
            <!--EDITING PLANTING REQUEST-->
                    <div id="editPlanting" title="Dialog Title" class="infoSection popUpBox ">
                            <form class="popup-content animate">
                            <div class="infoSection">Updating Request</div>
                                
                                <div class="sampId" style="display:hidden"></div>
                                    
                                    <label for="updtlotName">Lot Name:</label>
                                    <input type="text" id="updtlotName" name="updtlotName"/><br>
                                    <label for="updtgrower">Grower:</label>
                                    <input type="text" id="updtgrower" name="updtgrower"/><br>
                                    <label for="updtRanch">Ranch:</label>
                                    <input type="text" id="updtRanch" name="updtRanch"/><br>
                                    <label for="updtSampSize">Sample Size:</label>
                                    <input type="text" id="updtSampSize" name="updtSampSize"/><br>
                                    <label for="updtComp">Company Name:</label>
                                    <input type="text" id="updtComp" name="updtComp"/><br>
                                    <label for="updtreqDate">Request Date:</label>
                                    <input type="date" id="updtreqDate" name="updtreqDate"/><br>
                                    <label for="status">Status:</label>
                                    <input type="text" id="status" name="status"/><br>
                                    
                                <input type="submit" onclick='updatingSamp()' value="Update" name="updateForm">
                                <button id="cancelbtn" type="button"  onclick="document.getElementById('editPlanting').style.display='none'" class="cancelbtn">Cancel</button>
                            </form>
                    </div>
...
<!--LIBRARY SCRIPTS-->
    ...
    ///////////////ADDING MAIN RECORD INFO TO SIDE C//////////////
            ...
            //////////INVENTORY INFO/////////
                ...
                //CREATING INVENTORY INFO DIV
                    var invInfoSec=$("<div></div>");
    				invInfoSec.attr("id", "invInfoSec");
    				// invInfoSec.attr("class", "infoSection");
    			...
    			//CREATING INVENTORY INFO AMOUNT DIV	
    			  ...
    			  //APPENDING TO INVENTORY DIV	
    				invInfoSec.append(reqSampleSize);
    			...
    			//CREATING INVENTORY INFO Date Time DIV	
    				...
    				reqDate.attr("id", "dateAdded");
    			  //APPENDING TO INVENTORY DIV	
    				invInfoSec.append(reqDate);
    			
    			/////APPENDING INVENTORY INFO DIV TO CURRENT RECORD BODY DIV
    				$('#currentRecInfo').append(invInfoSec);
    		...
    		//////////BUTTONS/////////
    			...
    			//CREATING PRINT/DOWNLOAD BUTTONS	
    				var btnInfo=$("<div></div>");
    				btnInfo.append("<button id='compReq' onclick='displayPopUp()'>Complete Request</button> <button id='invPrint' onclick='printFunction()'>Print</button> <button id='invDownload' onclick='generatePDF()'>Download</button>");
    			...
    			//CREATING EDIT/DELETE BUTTONS	
    				...
    				btnInfo2.append("<button id='invEdit' onclick ='updateSampRec()'>Edit </button> <button onclick='deleteSampRecord()' id='invDelete'>Delete</button>");
    ...
    ///////////////PRINT & DOWNLOAD FUNCTIONS///////////////
        ...
        /////// INVENTORY DOWNLOAD PDF
                function generatePDF(){
                    ...
                    var reqCust= $("#reqCust").html();
                    var reqLotName= $("#reqLotName").html();
                    var reqGrower= $("#reqGrower").html();
                    var reqRanch= $("#reqRanch").html();
                    var reqSampleSize= $("#reqSampleSize").html();
                    var reqDate= $("#reqDate").html();
                    var reqUserName= $("#reqUserName").html();
                    var reqStatus= $("#reqStatus").html();
                    var dateAdded= $("#dateAdded").html();
                    ...
                    /////THIS IS A TITLE STYLED FOR PDF
                        ...
                        doc.text(40, 150, invTitle); //(X(SIDE TO SIDE), Y(UP DOWN), TEXT(WHAT GOES INSIDE)
            
                    /////THIS IS AN INFO PEICE STYLED FOR PDF
                        doc.setFontSize(12)
                        doc.setTextColor(0, 0, 0)
                        doc.setFont('courier')
                        doc.text(50, 180, reqCust);  
                        
                    /////THIS IS AN INFO PEICE STYLED FOR PDF
                        doc.setFontSize(12)
                        doc.setTextColor(0, 0, 0)
                        doc.setFont('courier')
                        doc.text(300, 180, reqLotName); 
                ...
                doc.line(40, 185, 560, 185)
                    ...
                    /////THIS IS AN INFO PEICE STYLED FOR PDF
                        ...
                        doc.setTextColor(0, 0, 0)
                        doc.setFont('courier')
                        doc.text(50, 205, reqGrower);  
                        
                  /////THIS IS AN INFO PEICE STYLED FOR PDF
                        doc.setFontSize(12)
                        doc.setTextColor(0, 0, 0)
                        doc.setFont('courier')
                        doc.text(300, 205, reqRanch);  
                ...
                /////THIS IS AN INFO PEICE STYLED FOR PDF
                        ...
                        doc.setTextColor(0, 0, 0)
                        doc.setFont('courier')
                        doc.text(50, 230, reqSampleSize);  
                        
                  /////THIS IS AN INFO PEICE STYLED FOR PDF
                        doc.setFontSize(12)
                        doc.setTextColor(0, 0, 0)
                        doc.setFont('courier')
                        doc.text(300, 230, reqDate);  
                ...
                /////THIS IS AN INFO PEICE STYLED FOR PDF
                        ...
                        doc.setTextColor(0, 0, 0)
                        doc.setFont('courier')
                        doc.text(50, 255, reqUserName);  
                        
                  /////THIS IS AN INFO PEICE STYLED FOR PDF
                        doc.setFontSize(12)
                        doc.setTextColor(0, 0, 0)
                        doc.setFont('courier')
                        doc.text(300, 255, reqStatus);  
                        
                doc.setLineWidth(.8)
                doc.line(40, 260, 560, 260) 
                
                /////THIS IS AN INFO PEICE STYLED FOR PDF
                        doc.setFontSize(12)
                        doc.setTextColor(0, 0, 0)
                        doc.setFont('courier')
                        doc.text(50, 280, dateAdded);  
                        
                //   /////THIS IS AN INFO PEICE STYLED FOR PDF
                //         doc.setFontSize(12)
                //         doc.setTextColor(0, 0, 0)
                //         doc.setFont('courier')
                //         doc.text(300, 280, reqStatus);  
                        
                doc.setLineWidth(.8)
                doc.line(40, 285, 560, 285) 
    ...
    //////////////UPDATING RECORD POPUP WINDOW//////////////
        ...
        ////////ADDING TO COLLECTED SAMPLES
                ...
                function addingSample(){
                            var sampReq=$(".sampId").html();
                            var sampActAmnt=$("#actSampleAmnt").val();
                            var sampdate=$("#date").val();
                            var date= moment().format('YYYY-MM-DD');
                            var time= moment().format('hh:mm:ss');
                            
                            console.log(sampdate);
                         
                            $.ajax({
                                type: "GET",
                                url: "addCollectedSamp.php",
                                data: {
                                    "sampReq": sampReq,
                                    "sampActAmnt": sampActAmnt,
                                    "sampdate": sampdate,
                                    "date": date,
                                    "time": time,
                                }
        ...
        ////////UPDATING SAMPLING REQ
                function updateSampRec(){
                    
                    $("#editPlanting").attr("style","display:block;")
                    ...
                    $.ajax({
                        ...
                        .done(function(data) {
                            ...
                            var sampReq = JSON.parse(data);
                            console.log(sampReq);
                            console.log(sampReq[0].Id);
                            
                            
                        $("#updtlotName").attr("value", sampReq[0].lotName);
                        $("#updtgrower").attr("value", sampReq[0].grower);
                        $("#updtRanch").attr("value", sampReq[0].ranch);
                        $("#updtSampSize").attr("value", sampReq[0].sampleSize);
                        $("#updtComp").attr("value", sampReq[0].compId_name);
                        $("#updtreqDate").attr("value", sampReq[0].reqDate);
                        $("#status").attr("value", sampReq[0].status);
                ...
                function updatingSamp(){
                    
                    var sampId= $(".sampId").html();
                    console.log(sampId);
                    
                        var updtlotName=$("#updtlotName").val();
                        var updtgrower=$("#updtgrower").val();
                        var updtRanch=$("#updtRanch").val();
                        var updtSampSize=$("#updtSampSize").val();
                        var updtComp=$("#updtComp").val();
                        var updtreqDate=$("#updtreqDate").val();
                        ...
                        var time= moment().format('hh:mm:ss');
                            ...
                            $.ajax({
                                type: "GET",
                                url: "updateSampRec.php",
                                data: {
                                    "sampId": sampId,
                                    "updtlotName": updtlotName,
                                    "updtgrower": updtgrower,
                                    "updtRanch": updtRanch,
                                    "updtSampSize": updtSampSize,
                                    "updtComp": updtComp,
                                    "updtreqDate": updtreqDate,
                                    "status": status,
                                    "date": date,
                                    "time": time
                                }
    ...
    /////////GETTING UPDATING RECORD STATUS - FUNCTION
    ...
    //////////////DELETING AND ADDING RECORDS//////////////
        ...
        /////////DELETING INVENTORY RECORD - FUNCTION
                function deleteSampRecord(){
                        
            			var sampId=$('.sampId').html();
            			
            			var response=confirm ("Are You Sure You Want To Delete:  "+ $('#reqCust').html() + "  " +$("#reqLotName").html());
