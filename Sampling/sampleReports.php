        ...
        <div id="bodyWrapper">
            <div class="mainDivs" id="nav">
                    ...
                    <ul id="pagesNav">
                      ...
                      <li><a class="navBtn active" href="sampleReports.php">Sampling Reports</a></li>
            ...
            <div class="mainDivs" id="collectiveInfo">
                ...
                <div id="records">
                    <div id="inventory">
                        <div class="title">
                            <div>Sampling Request Reports</div>
                        </div>
                        <div class="table">
    ...
    ///////////////ADDING MAIN RECORD INFO TO SIDE C//////////////
            ...
            $('#currentInventory').on('click', function(e){
                ...
                .done(function(data) {
                    ...
                    var sampReport = JSON.parse(data);
            ...
            //////////INVENTORY INFO/////////
                ...
                //CREATING INVENTORY INFO DIV
                    var sampReportInfo=$("<div></div>");
    				sampReportInfo.attr("id", "sampReportInfo");
    				// collsampInfoSec.attr("class", "infoSection");
    				
    			//CREATING INVENTORY INFO TITLE DIV	
                    var sampRepInfo=$("<div></div>");
    				sampRepInfo.append("Sample Report Info");
    				sampRepInfo.attr("class", "secTitle");
    				sampRepInfo.attr("id", "sampRepInfo");
    				sampRepInfo.css("font-size", "30px");
    		      //APPENDING TO INVENTORY DIV	
    				sampReportInfo.append(sampRepInfo);
                    
    			//CREATING INVENTORY INFO AMOUNT DIV	
    				var actSampAmnt=$("<div></div>");
    				actSampAmnt.append("Sample Submission Time: "+sampReport[0].sampSubTime);
    				actSampAmnt.attr("class", "recInfo");
    				actSampAmnt.attr("id", "rptSubTime");
    			  //APPENDING TO INVENTORY DIV	
    				sampReportInfo.append(actSampAmnt);
    				
    			//CREATING INVENTORY INFO AMOUNT DIV	
    				var sampDate=$("<div></div>");
    				sampDate.append("W.O. Number: "+sampReport[0].WONumber);
    				sampDate.attr("class", "recInfo");
    				sampDate.attr("id", "rptWONum");
    			  //APPENDING TO INVENTORY DIV	
    				sampReportInfo.append(sampDate);
    				
    			//CREATING INVENTORY INFO User DIV	
    				var collUserName=$("<div></div>");
    				collUserName.append("Added by: "+sampReport[0].userName);
    				collUserName.attr("class", "recInfo");
    				collUserName.attr("id", "rptUserName");
    			  //APPENDING TO INVENTORY DIV	
    				sampReportInfo.append(collUserName);
    				
    			//CREATING INVENTORY INFO Date Time DIV	
    				var collDateTime=$("<div></div>");
    				collDateTime.append("Date added : "+sampReport[0].date +" / "+ sampReport[0].time);
    				collDateTime.attr("class", "recInfo2");
    				collDateTime.attr("id", "rptDateTime");
    			  //APPENDING TO INVENTORY DIV	
    				sampReportInfo.append(collDateTime);
    			
    // 			/////APPENDING INVENTORY INFO DIV TO CURRENT RECORD BODY DIV
    				$('#currentRecInfo').append(sampReportInfo);
    		...
    		//////////BUTTONS/////////
    			...
    			//CREATING PRINT/DOWNLOAD BUTTONS	
    				var btnInfo=$("<div></div>");
    				btnInfo.append("<button id='invPrint' onclick='printFunction()'>Print</button> <button id='invDownload' onclick='generatePDF()'>Download</button>");
    			...
    			//CREATING EDIT/DELETE BUTTONS	
    				...
    				btnInfo2.append("<button id='invEdit' onclick ='editRequest()'>Edit </button> <button onclick='deleteCollReport()' id='invDelete'>Delete</button>");
    ...
    ///////////////PRINT & DOWNLOAD FUNCTIONS///////////////
            ...
            /////// INVENTORY DOWNLOAD PDF
                function generatePDF(){
                    var title= $("#sampRepInfo").html();
                    var subTime= $("#rptSubTime").html();
                    var WONum= $("#rptWONum").html();
                    var user= $("#rptUserName").html();
                    var dateTime= $("#rptDateTime").html();
                    ...
                    /////THIS IS A TITLE STYLED FOR PDF
                        ...
                        doc.text(40, 150, title); //(X(SIDE TO SIDE), Y(UP DOWN), TEXT(WHAT GOES INSIDE)
            
                    /////THIS IS AN INFO PEICE STYLED FOR PDF
                        doc.setFontSize(12)
                        doc.setTextColor(0, 0, 0)
                        doc.setFont('courier')
                        doc.text(50, 180, subTime);  
                        
                    /////THIS IS AN INFO PEICE STYLED FOR PDF
                        doc.setFontSize(12)
                        doc.setTextColor(0, 0, 0)
                        doc.setFont('courier')
                        doc.text(300, 180, WONum); 
                ...
                doc.line(40, 185, 560, 185)
                    ...
                    /////THIS IS AN INFO PEICE STYLED FOR PDF
                        ...
                        doc.setTextColor(0, 0, 0)
                        doc.setFont('courier')
                        doc.text(50, 205, dateTime);  
                        
                //   /////THIS IS AN INFO PEICE STYLED FOR PDF
                //         doc.setFontSize(12)
                //         doc.setTextColor(0, 0, 0)
                //         doc.setFont('courier')
                //         doc.text(300, 205, dateAdded);  
